<template>
	<div class="groups-page">
		<div class="container">
			<button v-b-modal.createGroup class="btn btn-create" size="sm">Crear Grupo</button>
					...
					<tbody>
						<tr v-for="(item, index) in groups" :key="index">
							...
							<td>
								...
								<button class="btn btn-group btn-sm" v-on:click="saveGroupToEdit(item)" v-b-modal.editModal>Editar grupo</button>
		...
		<b-modal id="createGroup" ref="createGroup" hide-footer size="md" centered>
	 		<div>
		...
		<b-modal id="viewModal" ref="viewModal" hide-footer title="Estudiantes" size="lg">
				<div class="table">
					<table>
							<thead>
								<tr>
